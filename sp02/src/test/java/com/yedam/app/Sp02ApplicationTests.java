...
//		EmpVO emp =  EmpVO.builder().emplyoeeId(1001).lastName("Kang").email("kg1@google.com").jobId("SA_REP").build();
...
//	@Test
	...
	public void updateInfo() {
		//1)단건조회
		EmpVO emp = EmpVO.builder().employeeId(1001).build();
		EmpVO findVO = empMapper.selectInfo(emp);
